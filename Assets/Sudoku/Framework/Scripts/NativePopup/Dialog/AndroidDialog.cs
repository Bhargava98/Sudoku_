...
public class AndroidDialog : MonoBehaviour
{
    ...
    {
        return Create(title, message, "SignOut", "Cancel");
    }
    ...
    public void OnDialogPopUpCallBack(string buttonIndex)
    {
        ...
        //        if (PluginManager.Instance.isSignOut)
        //            PluginManager.Instance.GooglePlaySignOut();
        //        else
        //            Application.OpenURL("https://www.9gape.com/terms-of-service/");
        //        if (ScreenManager.Instance.isTerms)
        //        {
        //            ScreenManager.Instance.ShowGameStartAd();
        //            ScreenManager.Instance.isTerms = false;
        //        }
