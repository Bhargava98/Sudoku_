...
namespace BizzyBeeGames
{
	public class SoundManager : SingletonComponent<SoundManager>, ISaveable
	{
        ...
        //public bool IsMistakesOn        { get; private set; }
		#endregion
		...
		protected override void Awake()
		{
           ...
           // print("IsVibration: " + IsVibrationOn);
        }
        ...
        public void SetValueOnOff(ButtonType type,bool isOn)
        {
            switch (type)
            {
                case ButtonType.vibration:
                    ...
                    IsVibrationOn = isOn; //print("IsVibration: "+ IsVibrationOn);

                    break;
                //case ButtonType.mistakes:

                //    if (isOn == GameManager.Instance.ShowIncorrectNumbers)
                //    {
                //        return;
                //    }

                //    GameManager.Instance.ShowIncorrectNumbers = isOn;
		...
		public Dictionary<string, object> Save()
		{
           ...
           // json["is_mistakes_on"]         = IsMistakesOn;
			return json;
		}
		...
		public bool LoadSave()
		{
           ...
           // IsMistakesOn        = json["is_mistakes_on"].AsBool;
			return true;
		}
